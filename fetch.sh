...
mv packaged/"$lan"/"$lan".txt.gz packaged/"$lan"/"$lan"_part_1.txt.gz
done

find ./packaged -mindepth 1 -type d ! -path './packaged/en' -type d ! -path './packaged/ru' \
-type d ! -path './packaged/el' -type d ! -path './packaged/de' -type d ! -path './packaged/pl' \
